/**
 * Created by jpt on 2018/3/24 0024.
 */
/**
...
//import G2      from 'antd/../../publics/js/g2';
//import dataset from 'antd/../../publics/js/data-set';
import Profiles from '../../profiles/index';
import { ObjectUtilities } from '../../lib/';
import { fetch } from '../../utils/';
import styles from './BargraphChart.less';
 ...
 * @extends Component
 * */
class BargraphChartA extends Component {
  ...
  render() {
    ...
    return (
      <div
        ...
        {..._props}
        style={_style}>
        <p className={styles.title}> 柱状图 </p>
      </div>
    )
  }
}
...
/**
 * some desc
 * @exports Form.create()(BargraphChartA)
 * @default Form.create()(BargraphChartA)
 * */
export default BargraphChartA;
