...
class DelPOCTBoxModal extends Component{
...
DelPOCTBoxModal.defaultProps = {
  prefix: 'yzh-d',
  visible: false,
  callback: noop,
};

DelPOCTBoxModal = Form.create()(DelPOCTBoxModal);

export default DelPOCTBoxModal;
