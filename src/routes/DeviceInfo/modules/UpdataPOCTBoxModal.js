/**
 * Created by jpt on 2018/4/10 0010.
 */
/**
 * Created by jpt on 2018/4/10 0010.
 */
...
class UpdataPOCTBoxModal extends Component{
        ...
        <Form layout="horizontal" >
          ...
          >
            {getFieldDecorator('value', {
              ...
              rules: [{required: false,  message:'请输入设备类型编号' },]
            })(
              <Input
                style={{width: 400}}
...
UpdataPOCTBoxModal.defaultProps = {
  prefix: 'yzh-d',
  visible: false,
  callback: noop,
};

UpdataPOCTBoxModal = Form.create()(UpdataPOCTBoxModal);

export default UpdataPOCTBoxModal;
