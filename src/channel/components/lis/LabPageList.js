...
class LabPageList extends Component {
  _retInitialState = ()=>{
    return {
...
//-----------------------------------------------end 删除订单 --------------------------------------
  ...
  addRecipeClick = ({rowdata: selectedRows})=>{
    this.showRecipeModal({data: {...selectedRows}});
  };
...
LabPageList.propTypes = {
  prefix: PropTypes.string,
  rowKey: PropTypes.string
};
LabPageList.defaultProps = {
  prefix: 'yzh-d',
  rowKey: 'id'
};

LabPageList = Form.create()(LabPageList);
...
export default connect(mapStateToProps)(LabPageList);
