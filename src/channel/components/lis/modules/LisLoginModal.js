...
function noop(){}
class LisLoginModal extends Component{
...
LisLoginModal.defaultProps = {
  prefix: 'yzh-d',
  visible: false,
  callback: noop,
};

LisLoginModal = Form.create()(LisLoginModal);

export default LisLoginModal;
