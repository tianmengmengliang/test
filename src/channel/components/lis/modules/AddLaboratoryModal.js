            ...
            <Row>
              ...
              >
                {getFieldDecorator('residence', {
                  ...
                  rules: [{ type:'array', required: false,  message: '请选择设备所在地' }],
                })(
            ...
            <Row>
              ...
              >
                {getFieldDecorator('address', {
                  ...
                  rules: [{
                    required: false, message: '请填写精确地址',
                  }]
                })(
                  <Input
                    size="large"
            ...
            <Row>
              ...
              >
                {getFieldDecorator('lisVersion', {
                  ...
                  rules: [{
                    required: false, message: '请填写Lis版本',
                  }]
                })(
                  <Input
                    size="large"
