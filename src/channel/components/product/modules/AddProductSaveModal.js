 ...
 * 创建项目,对话框。
 */
class AddProductSaveModal extends Component{
          ...
          <Form layout='horizontal'>
            ...
            <Row>
              ...
              <Col span={12}><Form.Item
                ...
                //hasFeedback
              >
                {getFieldDecorator('medicalRegisterCode', {
                  initialValue: data.medicalRegisterCode,
                  rules: [{
                    required: true, message: '请填写医疗注册号',
                  }]
                })(
                  <Input
                    size="large"
                    style={{ width: '75%', marginRight: '3%' }}
                    placeholder={`请输入医疗注册号`}/>
                )}
              </Form.Item></Col>
            </Row>
            ...
            <Row>
              ...
              >
                {getFieldDecorator('erpCode', {
                  initialValue: data.erpCode,
                  rules: [{
                    required: true, message: '请填写erp编号',
                  }]
                })(
                  <Input
                    size="large"
...
AddProductSaveModal.defaultProps = {
  prefix: 'yzh',
  visible: false,
  callback: noop,
};

AddProductSaveModal = Form.create()(AddProductSaveModal);

export default AddProductSaveModal;
