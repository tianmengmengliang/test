/**
 * Created by jpt on 2018/5/19 0019.
 */
...
import {searchSampleTypeByValues} from 'antd/../../src/compoents2/location/SampleTypeList.js'; //匹配设备类型
...
class LabMenu extends Component {
  ...
  render() {
    ...
    return (
      <div style={{marginTop:-20,//background:'#f00'
        }}>
        <Card bordered={false}>
          <Tabs defaultActiveKey={activeKey} onChange={this.onTabClick} size={'large'} style={{fontSize: 16 }}>
            <TabPane tab="&emsp;&emsp;医嘱&emsp;&emsp;" key="1">
            ...
            <TabPane tab="&emsp;&emsp;项目&emsp;&emsp;" key="2">
              <LabProject />
            </TabPane>
            <TabPane tab="&emsp;实验室&emsp;" key="3">
              <Laboratory />
            </TabPane>
          </Tabs>
        </Card>
