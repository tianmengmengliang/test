...
import {AddDepartmentModal,} from './modules/'
...
class ProductList extends Component {
  ...
  render() {
    ...
    const { listPage: {pageIndex, pageSize, rows:dataSource, total}, tableLoading, spinning,
      selectedIds, selectedRows, tip, addDepartmentModal, residences,} = this.state;
      ...
      <PageHeaderLayout>
        <div style={{marginTop: -20,}}>
          <div className="hidden">
            <AddDepartmentModal {...addDepartmentModal} callback={this.addCallback} />
          </div>
          ...
          <Card bordered={false}>
            ...
            <Spin
              ...
              {/* 1.查询栏 */}
              <ButtonContainer>
                <Button onClick={this.add.bind(this, {type: 'add', data:{}})} type="primary"><Icon type="plus" />新增部门</Button>
