...
import {AddLabProjectModal, ViewLabProjectModal, AddRoleModal } from './modules/'
...
//-----------------------------------------------end 删除订单 --------------------------------------
  ...
  render() {
    ...
    const { listPage: {pageIndex, pageSize, rows:dataSource, total}, tableLoading, spinning,
      selectedIds, selectedRows, tip, addRoleModal, viewLabOptionModal, activeKey,} = this.state;
      ...
      <PageHeaderLayout>
        <div style={{marginTop: -20, }}>
          <div className="hidden">
            <AddRoleModal {...addRoleModal} callback={this.addCallback}/>
          ...
          <Card>
            ...
            <Spin
              ...
              tip={tip}>
              <ButtonContainer>
                <Button onClick={this.add.bind(this, {type: 'add', data:{}})}  type="primary"  icon="plus">角色添加</Button>
